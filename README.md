...
[Download the latest WordPress-ready plugin ZIP](https://github.com/octave-agency/plugin-octave-addons/releases/latest/download/octave-addons.zip)
...
See `octave-addons/modules/README.md`. Add a folder containing a `class-module.php` class that
